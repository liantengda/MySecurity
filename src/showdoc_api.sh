...
# 
api_key="83a5c51be809b38fec81c2c9458dd450338041716" 			#api_key
api_token="4a96e101dc24bcaa71a1bcd2443328d6778044891" 	#api_token
url="http://192.168.1.234:4999/server/?s=/api/open/fromComments" #同步到的url。使用www.showdoc.cc的不需要修改，使用开源版的请修改
#
#
#
#
